...
class FunctionalTestBase(unittest.TestCase):
    ...
    def run_jbom(self, args: List[str], expected_rc: Optional[int] = 0) -> Tuple[int, str, str]:
    ...
    def assert_csv_headers(self, csv_path: Path, expected_headers: List[str]) -> List[List[str]]:
