...
from jbom.sch.parser import KiCadParser  # noqa: F401
from jbom.sch.types import (  # noqa: F401
    get_component_type,
    get_category_fields,
...
# Import InventoryMatcher from inventory module (backward compatibility)
# All inventory matching logic now lives in jbom.inventory.matcher
from jbom.inventory import InventoryMatcher  # noqa: F401
            ...
            if matches:
                ...
                if (
                    ...
                    explicit_precision = bool(
                        _re.match(r"^\s*\d+[kKmMrR]\d+\s*", comp0.value or "")
                    )
                    tol_str = (
...
def _parse_fields_argument(
    ...
    return (
        deduped if deduped else _preset_fields("standard", include_verbose, any_notes)
    )
