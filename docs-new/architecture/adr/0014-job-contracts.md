# ADR 0014: Shared Job Execution Contracts
Date: 2026-02-25
Status: Accepted
...
The source document does not enumerate explicit consequences.
...
- `docs/dev/architecture/job-contracts.md` (content preserved verbatim)
