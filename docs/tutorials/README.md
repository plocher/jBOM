...
Welcome to jBOM. These tutorials walk you through real workflows, starting
from nothing and working up to customising jBOM for your team or fab house.

Each tutorial builds on the previous one. Start at the beginning if you are
new to jBOM.
...
### [2. Your First BOM](02-first-bom.md)
...
### [3. Finding and Enriching Parts](03-finding-enriching-parts.md)
...
- Bulk-match an entire inventory file against a supplier with `jbom inventory --supplier`
- Use a dry run to preview what will be searched before spending API quota
- Save an enriched inventory for BOM generation

### [4. Customising for Your Workflow](04-customising-workflow.md)
...
Once you have worked through the tutorials, the complete command reference is in
[`reference/cli.md`](../reference/cli.md) (generated from the CLI; see issue #269).

For configuration details — profile file format, search paths, environment
variables — see [`design/configuration-semantics.md`](../design/configuration-semantics.md).
