Feature: BOM Inventory Enhancement
  ...
  Background:
    ...
    And an inventory file "component_inventory.csv" that contains:
      ...
      | RES-10K-0603-E12   | RESISTOR  | 10k   | 10k Ohm resistor  | 0603    | Yageo        | RC0603FR-0710KL | C25804 | 75V     | 1%        |
      | CAP-100nF-0603-X7R | CAPACITOR | 100nF | 100nF ceramic cap | 0603    | Murata       | GRM188R71H104KA | C14663 | 50V     | 10%       |
      | LED-RED-0603-20mA  | LED       | RED   | Red LED 20mA      | 0603    | Kingbright   | APT1608SRCPRV   | C2286  | 2V      |           |
